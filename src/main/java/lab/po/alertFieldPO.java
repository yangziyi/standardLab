...
@Schema
public class alertFieldPO extends generalInfo implements Serializable {

    @Serial
    private static final long serialVersionUID = -6173245798815179161L;
    ...
    @Schema(description = "fielddocno字段编号")
    private String fielddocno;

    @Schema(description = "修改后的fielddocno字段编号")
    private String newFielddocno;

    @Schema(description = "fieldname字段名")
    ...
    public String getNewFielddocno() {
        return newFielddocno;
    }

    public void setNewFielddocno(String newFielddocno) {
        this.newFielddocno = newFielddocno;
    }
